...
try{
  ...
  window.__bbWarfareV40Bootstrap={build:40,parts:parts.length,sourceLength:source.length};
  if(badge){badge.textContent='V40 • NEW CORE LIVE • GAME-UPDATES';badge.style.background='#073b28';badge.style.borderColor='#50e69d';}
